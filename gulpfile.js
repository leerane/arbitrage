...
var path = {
  ...
  allImgPattern: "/**/*.{jpg,jpeg,png,gif,webp,svg}",
...
gulp.task("copy", gulp.parallel("copy:svg", "copy:fonts"));
...
gulp.task("watch", () => {
  ...
  gulp.watch(path.sourcePath + path.imgPath + path.imgPattern, gulp.series("compress"));
  gulp.watch(path.sourcePath + path.imgPath + path.svgPath + path.svgPattern, gulp.series("copy:svg"));
  gulp.watch(path.sourcePath + path.fontsPath + path.fontsPattern, gulp.series("copy:fonts"));
  gulp.watch(path.sourcePath + path.imgPath + path.svgPath + "/to-sprite" + path.svgPattern, gulp.series("sprite"));
});
